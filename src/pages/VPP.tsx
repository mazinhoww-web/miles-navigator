...
const VPP_TARGETS: Record<string, number> = { Smiles: 16, "Pass": 25, "Azul Fidelidade": 14 };
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <KpiCard label="Pass" value="R$25,00/1k" sub="maior spread do mercado" accent="blue" delay={2} />
